...
/**
 * @brief set shared (SPAKE) key to the auth at table, on the Management Client side
 *
 ...
 * This value is an ASCII-encoded string representing the hexadecimal serial number
 ...
 */
void oc_oscore_set_auth_mac(char *serial_number, int serial_number_size, char *clientrecipient_id,
 ...
 * @param shared_key_size the key size
 */
void oc_oscore_set_auth_device(char *serial_number, int serial_number_size, char *clientrecipient_id,
                        int clientrecipient_id_size, uint8_t *shared_key,
                        int shared_key_size);
