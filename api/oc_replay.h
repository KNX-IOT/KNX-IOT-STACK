 ...
 * 
 * If the client is synchronised, this function also updates its entry with the new SSN.
 * Thus, the replay window is updated 'in the background', through the natural usage
 * of this function
 * 
 * @param rx_ssn Sender Sequence Number of newly received OSCORE request
 * @param rx_kid Key Identifier of received request
