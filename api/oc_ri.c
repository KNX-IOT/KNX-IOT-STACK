...
oc_process_event_t oc_events[__NUM_OC_EVENT_TYPES__] = {
  OC_PROCESS_EVENT_MAX,      OC_PROCESS_EVENT_MAX + 1,
  OC_PROCESS_EVENT_MAX + 2,  OC_PROCESS_EVENT_MAX + 3,
  OC_PROCESS_EVENT_MAX + 4,  OC_PROCESS_EVENT_MAX + 5,
  OC_PROCESS_EVENT_MAX + 6,  OC_PROCESS_EVENT_MAX + 7,
  OC_PROCESS_EVENT_MAX + 8,  OC_PROCESS_EVENT_MAX + 9,
  OC_PROCESS_EVENT_MAX + 10, OC_PROCESS_EVENT_MAX + 11,
  OC_PROCESS_EVENT_MAX + 12, OC_PROCESS_EVENT_MAX + 13,
