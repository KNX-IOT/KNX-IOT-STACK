 ...
 * @see ets_unlisten_s_mode
 * @see ets_unlisten_s_mode_with_range
 * @see ets_unlisten_s_mode_single
 *
 ...
 * @return kisCS_EXPORT
 */
kisCS_EXPORT void ets_unlisten_s_mode(int scope, int ga_max, int iid);
